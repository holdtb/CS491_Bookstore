     ...
     echo '<div class="col-md-7 col-sm-7">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
                  ...
                  <hr>
                 <a href="buy_now.php?order=' . $offer_id .'"><button type="button" class="btn btn-success">Buy it now!</button></a>
                 <button type="button" class="btn btn-danger pull-right">Counter Offer</button>
                </div>
             </div>
      </div>';
  ?>
