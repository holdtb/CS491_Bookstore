...
<html lang="en">
  <head>
    ...
    <title>About -- WWU Bookstore</title>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">WWU Bookstore</a>
            </div>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <h2>Matt Lam</h2>
          <p>Everything you wanted to know about Matt Lam here...</p>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="images/personPlaceholder.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Bryan Holdt</h2>
          <p>Everything you wanted to know about Bryan Holdt here...</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
